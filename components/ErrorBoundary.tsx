      ...
      if (this.props.variant === 'module') {
        return (
          <div className="flex flex-col items-center justify-center h-64 gap-4 text-center p-6">
            ...
            <div>
              <p className="font-semibold text-slate-800 dark:text-slate-200">Ce module a rencontré une erreur</p>
              <p className="text-sm text-slate-500 mt-1">Les autres fonctionnalités restent disponibles.</p>
            </div>
            <button
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 p-4">
          <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-lg shadow-xl p-8 text-center">
            ...
            {this.state.error && (
              <div className="mb-6 p-4 bg-slate-100 dark:bg-slate-900 rounded text-left overflow-auto max-h-32 text-xs font-mono text-red-500">
