...
// APRÈS
className =
  'w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200';

// ReplayControlPanel.tsx L721 — AVANT
className = 'bg-slate-50 border border-slate-200 rounded-lg ...';
// APRÈS
className =
  'bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-700 dark:text-slate-200 ...';
