# CLAUDE.md — TrackYu GPS Frontend
...
| Domaine                                                          | Fichier                                    |
| ---------------------------------------------------------------- | ------------------------------------------ |
| Diagnostic balise GPS / carburant                                | `.claude/skills/gps-debug.md`              |
| Déploiements (staging / prod)                                    | `.claude/skills/deploy.md`                 |
| Design system / charte graphique                                 | `.claude/skills/frontend-design-system.md` |
| Modifications backend (src/ → build → deploy)                    | `.claude/skills/backend-workflow.md`       |
| Métier TrackYu (rôles, modules, règles)                          | `.claude/skills/metier-trackyu.md`         |
| Sécurité applicative (auth, rôles, patches)                      | `.claude/skills/security.md`               |
| Ingestion GPS (parsers, pipeline carburant)                      | `.claude/skills/data_ingestion.md`         |
| Base de données (schéma, requêtes, migrations)                   | `.claude/skills/databases.md`              |
| Finance & facturation (abonnements, Zoho)                        | `.claude/skills/finance_billing.md`        |
| App mobile (Expo, thèmes, navigation)                            | `.claude/skills/mobile_frontend.md`        |
| API & intégration frontend (React Query, WS)                     | `.claude/skills/api_integration.md`        |
| DevOps (Docker, CI/CD, backups VPS)                              | `.claude/skills/devops.md`                 |
| Réseau & protocoles GPS (GT06, CONCOX, ADC)                      | `.claude/skills/networking.md`             |
| Internationalisation (i18n FR→EN→ES)                             | `.claude/skills/internationalization.md`   |
| Tests (Jest, supertest, isolation tenant)                        | `.claude/skills/testing.md`                |
| Intégration IA (Claude API, AiAssistant)                         | `.claude/skills/ai_integration.md`         |
| UX/UI (design system, patterns composants)                       | `.claude/skills/ux_ui.md`                  |
| CRM & intégrations clients (Zoho, pipeline)                      | `.claude/skills/crm_integration.md`        |
| Conformité & données personnelles (RGPD)                         | `.claude/skills/compliance.md`             |
| Data science & analyses flotte (SQL, KPIs)                       | `.claude/skills/data_science.md`           |
| Gestion de projet (sprints, priorités, workflow)                 | `.claude/skills/project_management.md`     |
| Boîtiers GPS & analyse trames brutes (modèles, protocoles, fuel) | `.claude/skills/device_management.md`      |
