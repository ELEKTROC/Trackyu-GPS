...
### Production
```bash
trackyu-gps_postgres_1    # PostgreSQL/TimescaleDB (port 5432)
trackyu-gps_redis_1       # Cache Redis (port 6379)
trackyu-gps_backend_1     # API Node.js (port 3001)
trackyu-gps_frontend_1    # Nginx frontend (port 8080)
```
