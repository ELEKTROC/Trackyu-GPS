      ...
      <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="space-y-1">
            ...
            <input
              title="VIN"
              className="w-full px-3 py-2.5 border border-slate-200 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 text-sm font-mono uppercase"
              value={formData.vin || ''}
      ...
      <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {['checkStart', 'checkLights', 'checkDashboard', 'checkAC', 'checkAudio', 'checkBattery'].map((field) => (
            <label
              key={field}
              className="flex items-center p-3 border border-slate-200 dark:border-slate-700 rounded-lg cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors select-none"
            >
              <input
                type="checkbox"
                checked={!!(formData as Record<string, unknown>)[field]}
                onChange={(e) => setFormData({ ...formData, [field]: e.target.checked })}
                className="w-5 h-5 text-[var(--primary)] rounded border-slate-300 focus:ring-[var(--primary)] bg-white dark:bg-slate-900"
              />
        ...
        <div className="mt-4">
          ...
          <textarea
            className="w-full p-3 border border-slate-200 dark:border-slate-600 rounded-lg bg-slate-50 dark:bg-slate-900 text-sm min-h-[80px] resize-none"
