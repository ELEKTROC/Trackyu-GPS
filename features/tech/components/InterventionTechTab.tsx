        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="flex-1 py-3 bg-[var(--bg-elevated)] border border-[var(--border)] rounded-lg text-sm font-medium hover:bg-[var(--bg-elevated)] dark:hover:bg-slate-700 flex items-center justify-center gap-2"
            >
