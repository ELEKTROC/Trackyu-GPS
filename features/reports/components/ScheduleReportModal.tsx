...
export const ScheduleReportModal: React.FC<ScheduleReportModalProps> = ({ isOpen, onClose, onSchedule }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Programmer l'envoi du rapport" maxWidth="max-w-2xl">
      <form onSubmit={handleSubmit} className="p-6 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 bg-[var(--bg-elevated)] border border-[var(--border)] rounded-lg focus:ring-2 focus:ring-[var(--primary)] outline-none min-h-[100px]"
