...
export const AiAnalysisModal: React.FC<AiAnalysisModalProps> = ({ 
    isOpen, onClose, reportLabel, isAnalyzing, analysisResult, rowCount 
}) => {
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Analyse Intelligente (IA)">
            <div className="p-6 space-y-6">
                ...
                {isAnalyzing ? (
                    ...
                    <div className="prose prose-sm dark:prose-invert max-w-none bg-white dark:bg-slate-800 p-4 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm max-h-[400px] overflow-y-auto custom-scrollbar">
