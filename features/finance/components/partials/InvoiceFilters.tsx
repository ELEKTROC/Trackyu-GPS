    ...
    <div className="flex gap-3 flex-wrap">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="pl-9 pr-4 py-2 bg-[var(--bg-elevated)] border border-[var(--border)] rounded-lg text-sm w-full sm:w-64 text-[var(--text-primary)] placeholder-slate-400"
          value={searchTerm}
      ...
      <div className="relative">
        ...
        <select
          ...
          className="pl-9 pr-8 py-2 bg-[var(--bg-elevated)] border border-[var(--border)] rounded-lg text-sm appearance-none text-[var(--text-primary)]"
        >
      ...
      {availableResellers.length > 0 && (
        <div className="relative">
          <select
            ...
            className="pl-3 pr-8 py-2 bg-[var(--bg-elevated)] border border-[var(--border)] rounded-lg text-sm appearance-none text-[var(--text-primary)]"
          >
      ...
      {/* Column Manager */}
      <ColumnManager columns={columns} visible={visibleColumns} onChange={onColumnsChange} />
