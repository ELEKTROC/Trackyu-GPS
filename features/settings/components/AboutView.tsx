        ...
        <div className="p-6 w-full space-y-8 animate-in fade-in duration-500">
            <div className="text-center space-y-4">
                ...
                <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
                    La solution de gestion de flotte la plus avancée pour optimiser vos opérations, réduire vos coûts et sécuriser vos actifs.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-6 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <h3 className="font-bold text-slate-800 dark:text-white mb-2">Version 1.0.3</h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                        Dernière mise à jour le 17 Décembre 2025. Mode: {import.meta.env.VITE_USE_MOCK === 'true' ? 'SIMULATION' : 'PRODUCTION'}
                    </p>
                </div>
                <div className="p-6 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
                    <Shield className="w-8 h-8 text-green-500 mb-4" />
                    <h3 className="font-bold text-slate-800 dark:text-white mb-2">Sécurité</h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400">
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-8 border border-slate-200 dark:border-slate-700">
                <h3 className="text-lg font-bold text-slate-800 dark:text-white mb-4">Informations Légales</h3>
                <div className="space-y-4 text-sm text-slate-600 dark:text-slate-400">
                    <p>
                        <strong>Trackyu GPS Inc.</strong><br />
