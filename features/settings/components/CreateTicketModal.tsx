...
export const CreateTicketModal: React.FC<CreateTicketModalProps> = ({
  ...
  const handleCategoryChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (selectedCat) {
      setPriority(
        (selectedCat as { defaultPriority?: string; default_priority?: string }).defaultPriority ||
          (selectedCat as { defaultPriority?: string; default_priority?: string }).default_priority ||
          'MEDIUM'
      );
    }
  ...
  const handleSubCategoryChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (selectedSC) {
      setPriority(
        (selectedSC as { defaultPriority?: string; default_priority?: string }).defaultPriority ||
          (selectedSC as { defaultPriority?: string; default_priority?: string }).default_priority ||
          priority
      );
    }
    const v = clientVehicles.find((veh) => veh.id === vehicleId);
