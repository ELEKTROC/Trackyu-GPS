    ...
    <div className="space-y-6 p-6 w-full animate-in fade-in duration-500">
      ...
      <div className="bg-[var(--bg-elevated)] rounded-2xl p-6 shadow-sm border border-[var(--border)] flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="flex gap-3">
          <button
            onClick={logout}
            className="px-4 py-2 bg-[var(--clr-danger-dim)] text-[var(--clr-danger)] rounded-lg hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors flex items-center gap-2 font-medium text-sm"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="bg-[var(--bg-elevated)] border-[var(--border)]">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-[var(--border)] border-[var(--border)]">
              <div className="p-2 bg-[var(--clr-success-dim)] rounded-lg text-[var(--clr-success)]">
        ...
        <div className="space-y-6">
          <Card className="bg-[var(--bg-elevated)] border-[var(--border)]">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-[var(--border)] border-[var(--border)]">
              <div className="p-2 bg-[var(--clr-danger-dim)] rounded-lg text-[var(--clr-danger)]">
