...
export const MaintenanceForm = React.forwardRef<HTMLFormElement, BaseFormProps & { resellers?: Tier[], clients?: Tier[], branches?: unknown[], groups?: unknown[], vehicles?: Vehicle[], users?: User[] }>(({ initialData, onFormSubmit, resellers = [], clients = [], vehicles = [], users = [] }, ref) => {
    ...
    return (
        <form ref={ref} onSubmit={handleSubmit(onSubmit)} className="space-y-4 h-[600px] flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar space-y-4">
                ...
                <FormSection icon={Settings} title="Configuration Avancée">
                    ...
                    <div className="border-t border-slate-200 dark:border-slate-700 pt-4 mt-4">
                        ...
                        <div className="relative">
                            <label className="block text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wide mb-1.5">Destinataires (Utilisateurs)</label>
                            <button 
                                type="button" 
                ...
                <div className="relative">
                    <label className="block text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wide mb-1.5">Véhicules concernés</label>
                    <button 
                        type="button" 
