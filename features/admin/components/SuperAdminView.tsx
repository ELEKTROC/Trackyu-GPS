...
const ADMIN_MOBILE_HIDDEN = new Set([
  'whitelabel',
  'system',
  'audit-logs',
  'templates',
...
export const SuperAdminView: React.FC = () => {
  ...
  const ADMIN_TABS = useMemo(() => {
    const tabs = [
      ...
      {
        id: 'devices',
        label: 'Paramètres Boîtiers',
        icon: Settings,
        color: 'bg-[var(--bg-elevated)]',
        description: 'Configuration des trackers',
      },
      {
        id: 'whitelabel',
      ...
      },
      {
        ...
        icon: Webhook,
        color: 'bg-yellow-600',
        description: 'Intégrations événementielles',
        requiredRole: 'SUPERADMIN',
      },
      {
        id: 'organization',
      ...
      },
      {
        ...
        icon: Settings,
        color: 'bg-violet-500',
        description: 'Connexions tierces',
        requiredRole: 'SUPERADMIN',
      },
      {
        id: 'trash',
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-140px)] animate-in fade-in duration-500">
      ...
      >
        ...
        {!isMobile && <Tabs tabs={visibleAdminTabs} activeTab={activeTab} onTabChange={setActiveTab} />}
