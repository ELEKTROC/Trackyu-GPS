...
export const ActivityBlock: React.FC<ActivityBlockProps> = ({
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="bg-[var(--bg-elevated)] p-3 rounded border border-[var(--border)]">
          <div className="flex justify-between items-start mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-bold text-[var(--text-primary)]">Position Actuelle</span>
            </div>
          ...
          <div className="flex items-center gap-2 text-[10px] font-mono text-[var(--text-muted)]">
            ...
            {mockData.geofence && mockData.geofence !== 'N/A' && (
              <span className="px-1.5 py-0.5 bg-purple-100 text-purple-700 rounded font-bold border border-purple-200 truncate max-w-[150px]">
                {mockData.geofence}
              </span>
            )}
          </div>
      ...
      {/* Tableau Temps */}
      <div className="text-sm space-y-2 border-t border-[var(--border)] pt-2">
        <ConfigurableRow
          id="drivingTime"
          isConfigMode={isConfigMode}
          isHidden={hiddenFields.has('drivingTime')}
        ...
        <ConfigurableRow
          id="idleTime"
          isConfigMode={isConfigMode}
          isHidden={hiddenFields.has('idleTime')}
        ...
        <ConfigurableRow
          id="stoppedTime"
          isConfigMode={isConfigMode}
          isHidden={hiddenFields.has('stoppedTime')}
        ...
        <ConfigurableRow
          id="offlineTime"
          isConfigMode={isConfigMode}
          isHidden={hiddenFields.has('offlineTime')}
