    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose} title="Escalader le Ticket">
            <div className="space-y-4">
                ...
                <div className="flex items-start gap-3 p-4 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-xs text-orange-700 dark:text-orange-300 mt-1">
                            Priorité actuelle: <span className="font-bold">{currentPriority}</span> → <span className="font-bold">{getNextPriority()}</span>
                        </p>
                    </div>
                </div>
                ...
                {/* Raison prédéfinie */}
                <div>
                    <label htmlFor="escalate-reason" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
