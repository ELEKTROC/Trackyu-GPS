      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-4 py-2 bg-[var(--bg-elevated)] text-[var(--text-primary)] border border-[var(--border)] rounded-lg hover:bg-[var(--bg-surface)] flex items-center gap-2"
          >
            <Plus className="w-4 h-4" /> Catégorie
          </button>
          <button
            onClick={() => openArticleModal()}
            className="px-4 py-2 bg-[var(--primary)] text-white rounded-lg hover:bg-[var(--primary-light)] flex items-center gap-2"
          >
      ...
      <Card className="p-4">
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-6 py-3 bg-[var(--primary)] text-white rounded-lg hover:bg-[var(--primary-light)]"
          >
            Rechercher
          </button>
        </div>
        ...
        <div className="w-80 bg-[var(--bg-surface)] border border-[var(--border)] rounded-xl p-4 overflow-y-auto">
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <span className="text-xs bg-[var(--bg-elevated)] bg-[var(--bg-elevated)] px-2 py-0.5 rounded-full">
                {articles.length}
              </span>
            </button>
            {categories.map((cat) => (
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-xs text-[var(--text-secondary)]">
                            ...
                            {article.category_name && (
                              <span className="px-2 py-0.5 bg-[var(--bg-elevated)] rounded-full">
                                {article.category_name}
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex gap-1">
                          {article.status === 'DRAFT' && (
                            <button
                              onClick={() => publishArticleHandler(article.id)}
                          ...
                          {article.status === 'PUBLISHED' && (
                            <button
                              onClick={() => archiveArticleHandler(article.id)}
                          ...
                          {article.tags && article.tags.length > 0 && (
                            <div className="flex items-center gap-2 mt-4">
                              ...
                              {article.tags.map((tag, idx) => (
                                <span
                                  key={idx}
                                  className="px-2 py-1 bg-[var(--primary-dim)] text-[var(--primary)] rounded text-xs"
                                >
                                  {tag}
                                </span>
                              ))}
