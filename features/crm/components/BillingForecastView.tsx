          ...
          {(
            [
              ...
              },
              {
                status: null,
                label: 'Prévision',
                color: 'bg-slate-100  text-slate-500  dark:bg-slate-700/50  dark:text-slate-400',
              },
            ] as const
          ).map(({ label, color }) => (
            ...
            <table className="w-full text-xs">
              <thead className="bg-slate-50 dark:bg-slate-900 sticky top-0 z-10">
                <tr>
                  ...
                  <th className="text-right px-3 py-3 font-bold text-slate-500 uppercase tracking-wide whitespace-nowrap w-20">
                    Total
                  </th>
                </tr>
              </thead>
                  ...
                  return (
                    <React.Fragment key={contract.contractId}>
                      ...
                      <tr className="bg-slate-50 dark:bg-slate-800/60 hover:bg-slate-100 dark:hover:bg-slate-700/40">
                        ...
                        <td className="text-right px-3 py-2.5 font-bold text-slate-800 dark:text-white">
                          {format(cAnnual)}
                        </td>
                      </tr>
              ...
              <>
                ...
                <div className="px-4 py-3 space-y-2">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-medium text-slate-700 dark:text-slate-200 text-right max-w-[160px] truncate">
