        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <FormField label="N° Client">
                        <div className="relative">
                            <Input 
                                ...
                                readOnly 
                                className="bg-slate-100 dark:bg-slate-700 font-mono cursor-not-allowed"
                            />
                            {isNew && formData.id && (
            ...
            <div className="flex justify-end gap-2 pt-4 border-t border-slate-100 dark:border-slate-700 mt-4">
                <button 
                    type="button"
                    onClick={onCancel} 
                    className="px-4 py-2.5 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-bold hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center gap-2 transition-colors"
                >
